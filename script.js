...
function loadModal(id) {
    ...
    modalContainer.innerHTML = '<span class="loading loading-infinity loading-lg"></span>';
...
function displayModal(product) {
    ...
    <div class="card bg-base-100 w-full shadow-sm">
        ...
        <div class="card-body">
          ...
          <div class="font-bold text-2xl">$${product.price.toFixed(2)}</div>
          <div class="card-actions justify-end">
            <button class="btn flex-1 btn-primary"><i class="fa-solid fa-cart-plus"></i> Add To Cart</button>
          </div>
        </div>
    </div>
        `;
